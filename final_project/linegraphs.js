...
d3.select(".asian").append("circle").attr("cx", 475).attr("cy", 167).attr("r", 6).style("fill", "#69b3a2")
d3.select(".asian").append("circle").attr("cx", 475).attr("cy", 197).attr("r", 6).style("fill", "#7B9891")
d3.select(".asian").append("circle").attr("cx", 475).attr("cy", 227).attr("r", 6).style("fill", "#3D7165")
d3.select(".asian").append("text").attr("x", 490).attr("y", 170).text("All").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".asian").append("text").attr("x", 490).attr("y", 200).text("Male").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".asian").append("text").attr("x", 490).attr("y", 230).text("Female").style("font-size", "15px").attr("alignment-baseline", "middle")

d3.select(".black").append("circle").attr("cx", 475).attr("cy", 167).attr("r", 6).style("fill", "#FA6900")
d3.select(".black").append("circle").attr("cx", 475).attr("cy", 197).attr("r", 6).style("fill", "#BFA089")
d3.select(".black").append("circle").attr("cx", 475).attr("cy", 227).attr("r", 6).style("fill", "#884A1C")
d3.select(".black").append("text").attr("x", 490).attr("y", 170).text("All").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".black").append("text").attr("x", 490).attr("y", 200).text("Male").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".black").append("text").attr("x", 490).attr("y", 230).text("Female").style("font-size", "15px").attr("alignment-baseline", "middle")

d3.select(".white").append("circle").attr("cx", 475).attr("cy", 167).attr("r", 6).style("fill", "#785Bd7")
d3.select(".white").append("circle").attr("cx", 475).attr("cy", 197).attr("r", 6).style("fill", "#8376AF")
d3.select(".white").append("circle").attr("cx", 475).attr("cy", 227).attr("r", 6).style("fill", "#3D2B78")
d3.select(".white").append("text").attr("x", 490).attr("y", 170).text("All").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".white").append("text").attr("x", 490).attr("y", 200).text("Male").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".white").append("text").attr("x", 490).attr("y", 230).text("Female").style("font-size", "15px").attr("alignment-baseline", "middle")

d3.select(".hispanic").append("circle").attr("cx", 475).attr("cy", 167).attr("r", 6).style("fill", "#187bcd")
d3.select(".hispanic").append("circle").attr("cx", 475).attr("cy", 197).attr("r", 6).style("fill", "#698BA7")
d3.select(".hispanic").append("circle").attr("cx", 475).attr("cy", 227).attr("r", 6).style("fill", "#264C6B")
d3.select(".hispanic").append("text").attr("x", 490).attr("y", 170).text("All").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".hispanic").append("text").attr("x", 490).attr("y", 200).text("Male").style("font-size", "15px").attr("alignment-baseline", "middle")
d3.select(".hispanic").append("text").attr("x", 490).attr("y", 230).text("Female").style("font-size", "15px").attr("alignment-baseline", "middle")
